...
Public Class Form1
    ...
    Public Sub ShowRecord(index As Integer)
        ...
        If records(index) <> Nothing Then
            ...
            BrandTextbox.Text = Fields(0)
            ModelTextbox.Text = Fields(1)
            YearTextbox.Text = Fields(2)
            MilageTextbox.Text = Fields(3)
            PriceTextbox.Text = Fields(4)
